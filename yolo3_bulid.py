...
MODEL_PATH = './checkpoints/plate.h5'
...
class YOLO(object):
    ...
    def detect_image(self, image_path):
        ...
        for i,c in enumerate(out_classes):
            ...
            cv2.rectangle(draw_im, (left,top), (right,bottom), (0, 0, 255), 3)
            plate = draw_im[top:bottom, left:right, :]
            lbs = PR(plate, False)
            text = lbs[0]
            print(text)
            text_loc = (left,top)
            cv2.putText(draw_im,text,text_loc[::-1],cv2.FONT_HERSHEY_DUPLEX, 1, (0,0,255), 2)
        return draw_im,text

if __name__ == '__main__':
    a = YOLO()
    im,text = a.detect_image('./5.jpg')
    cv2.imshow('im',im)
    cv2.waitKey(0)
